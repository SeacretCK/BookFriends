...
const state = {
  ...
  defaultProfilePicture:
    "https://firebasestorage.googleapis.com/v0/b/bookfriends-8ad5b.appspot.com/o/default-profile-pic.svg?alt=media&token=a4cce389-ab38-413c-94a2-ee88965c2a08",
  showSuccess: false,
  allMessages: [],
...
const actions = {
  ...
  setConversations({ commit, state }) {
    ...
    allMessagesArray.forEach((message) => {
      if (
        message.recipientId === state.currentUser.uid &&
        message.read === false
      ) {
